...
class ApplicationDirector:
    ...
    def construct_application(self, candidate_profile, jobsFile='jobApp/data/jobs.csv', application_type= 'Email' or 'Easy Apply' or 'Direct'):
        ...
        self.builder.set_jobs_file(jobsFile)
