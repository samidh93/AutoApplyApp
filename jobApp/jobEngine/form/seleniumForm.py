...
import json
import requests
from linkedinSeleniumBase import EasyApplyLinkedin
...
class SeleniumFormHandler(FormFillBase):
    def __init__(self, form_json_template='jobApp/secrets/form.json', url=None, csv_jobs='jobApp/data/links.csv'):
        ...
        data = ["project manager", "stroomrecruitment", "first last", "+phone" ]
        ...
        self.fields_candidate = {
            ...
            "cv":  f"{self.cwd}/jobApp/data/first_last_resume_english.pdf",
