...
class JobLinksMicroService:
    def __init__(self,service_name="job Links", csv_file='jobApp/data/links.csv', easyApply=False, num_pages_to_visit = 1):
        self.name = service_name
        print(f"initialising {self.name} microservice..")        
        self.jobParserObj= JobParser('jobApp/secrets/linkedin.json', csv_file )
        self.jobParserObj.setEasyApplyFilter(easyApply)
