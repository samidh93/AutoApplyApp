...
class JobParserBuilderMicroservice:
    def __init__(self,service_name="job parser builder", config_file='jobApp/secrets/linkedin.json', csv_links_out="jobApp/data/links.csv", csv_jobs_out="jobApp/data/jobs.csv",  num_pages_to_visit = 5):
