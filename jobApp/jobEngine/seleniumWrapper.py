...
class WebScraper:
    ...
    def login_user(self, url="https://www.linkedin.com/login", username_xpath='//*[@id="username"]', password_xpath='//*[@id="password"]', user_credentials="jobApp/secrets/linkedin.json", quit_after=False):
        ...
        input_username.send_keys(cred["email"])
    ...
    def getEasyApplyJobLinks(self, url, parameters) -> list:
        ...
        try:
            results = self.driver.find_element(By.CLASS_NAME,"jobs-search-results__list-item.occludable-update.p0.relative.ember-view")
            print(results)
        except:
        ...
        for result in results:
            ...
            hover.perform()
            titles = result.find_element(By.CLASS_NAME,'full-width.artdeco-entity-lockup__title.ember-view')
            for title in titles:
    ...
    def _easy_apply(self, by_what, tag):
        ...
        easyApply = self.driver.find_element(by_what, tag)
        easyApply.click()
        print("easy apply found, filling form")
        self.fill_easyApply("xxx", "yyy", "017666", "5",
    ...
    def fill_easyApply(self, first, last, phone_number, years_experience, resume_path):
        ...
        try:
            next = self.driver.find_element(
                By.CLASS_NAME, "//span[contains(text(),'Next')]")
        ...
        try:
            Review = self.driver.find_element(
                By.CLASS_NAME, "//span[contains(text(),'Review')]")
        ...
        try:
            Submit = self.driver.find_element(
                By.CLASS_NAME, "//span[contains(text(),'Submit application')]")
...
if __name__ == '__main__':
    ...
    scraper.getEasyApplyJobLinks(jobParserObj.base_url, jobParserObj.params)
#
