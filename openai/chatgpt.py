...
class ChatGPT:
    ...
    def ask(self, question):
        ...
        self.conversation += (message_history[0]["content"],message_history[1]["content"] )
...
if __name__ == '__main__':
    ...
    q1 = "describe islam in one word?"
    q2 = "describe buddism in one word?"
    q3 = "describe christianity in one word?"
